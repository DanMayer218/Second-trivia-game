...
function correct() {
	$("#answers div").click(function() {
		...
		if (questCorrect === true) {
			...
			questionBank[count].correct = "I see youve been practicing young cricket";
			count++;
			...
			questionBank[count].correct = "This is bootcamp coder! your never going to survive if you dont know your stuff!!";
			count++;
			clearInterval(intervalID);
			time = 20;
			setTimeout(function() {
...
function timer() {
	...
	if (time === 0) {
		...
		clearInterval(intervalID);
		time = 20;
		questionBank[count].correct = "Better stick with the psuedo coding rookie.";
		count++;
		setTimeout(function() {
			checkGameEnd();		
		}, 600);
